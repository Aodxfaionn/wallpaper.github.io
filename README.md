...
<p>Проект состоит из 11 страниц (функциональные компоненты) на TypeScript. Реализованы слайдер, табы, аккордеон, модальные окна. Валидация формы - с помощью Formik. Архитектура - попытка в Feature-Sliced Design.</p>
